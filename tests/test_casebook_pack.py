"""Regression checks for the signal-plat-image-pipe casebook."""
...
from casebook.harness import assert_expected, signal_plat_image_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(signal_plat_image_pipe_summary(), assert_expected())
